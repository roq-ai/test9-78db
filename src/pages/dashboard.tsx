...
import { useRoqPlatformUserProfiles, useProductCount, useCategoryCount, useReviewCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const categoryStat = useCategoryCount();
